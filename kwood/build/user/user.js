...
var User = /** @class */ (function () {
    function User() {
        ...
        this.password = '';
        this.superior = '';
        this.tuitionReimbursement = 1000;
        this.position = [];
        this.pendingReimbursements = 0;
        this.awardedReimbursements = 0;
    }
    return User;
}());
exports.User = User;
function login(username, password) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    log_1.default.debug("in login: " + (username + ' ' + password));
                    return [4 /*yield*/, user_service_1.default.getUserByUsername(username).then(function (user) {
